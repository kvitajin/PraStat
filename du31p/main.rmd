...
pak poslouží funkce pnbinom(10-4, 4, 0.83)
Delfínovi se s pravděpodobností 99.97% povede více, než 5 skoků z 10.
...
$$
P(X \geq 85 ) = \frac{P(X \geq 90 \wedge X \geq 80)}{P(X \geq 80)}
$$
...
![Hustota pravděpodobností](hustota_prav.png)

![Distribuční funkce](distribucni_funkce.png)
...
![Vyznačený graf hustoty pravděpodobností](srafovano.png)
